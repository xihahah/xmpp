...
// compute free emun index number
        ...
        */
        ...
        Strophe.Status.REGISTER = i + 2;       //11
        Strophe.Status.REGISTERED = i + 3;     //12 注册结束（注册成不成功都结束了）
        Strophe.Status.CONFLICT = i + 4;       //13 冲突
...
// this is either 'conflict' or 'not-acceptable'
    ...
    //填写注册信息
    setFields:function(iusername,ipassword){
        this.fields={
            username:iusername,
            password:ipassword
        }
